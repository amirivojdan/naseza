...
| ------------- | ------- | ------------------------------------------------------------------------------------------------------- |
| **Offensive** | 1,559   | Contains insults, slurs, or verbally aggressive language directed toward individuals, teams, or groups. |
| **Normal**    | 2,450   | Contains neutral, non-offensive, or contextually benign language.                                       |
